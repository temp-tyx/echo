...
class AscendDflashProposer(AscendEagleProposer):
    ...
    def build_model_inputs_first_pass(
        ...
        # Chunk precompute to avoid large temporary tensors in mixed
        # prefill+decode batches. Pure decode (num_context == num_input_tokens)
        # runs 1 chunk — no change from original behavior.
